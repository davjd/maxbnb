...
def generate_graphs():
    ...
    neighborhood_count_chart.render_to_file('static/assets/neighborhood_count.svg')
    ...
    most_expensive_chart.render_to_file('static/assets/most_expensive.svg')
    ...
    most_avaliable_chart.render_to_file('static/assets/most_available.svg')
